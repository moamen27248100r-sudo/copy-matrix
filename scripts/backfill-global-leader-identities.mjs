...
const LEADERS = [
  { id: "e7b20ecd-121b-47a0-aeca-a4f03ee2dd91", country: "US", name: "مايكل تيرنر", focus: "US30",
    bio: "متداول أمريكي محترف، متخصص في مؤشر داو جونز الصناعي ومتابعة حركة الأسواق الأمريكية عن كثب." },
  { id: "afda09da-9e88-4aaf-ad82-4b05ec232144", country: "GB", name: "شارلوت بينيت", focus: "GBPUSD",
    bio: "متداولة بريطانية متمرسة، تركّز على زوج الجنيه الإسترليني مقابل الدولار وتحليل قرارات بنك إنجلترا." },
  { id: "8ce804d0-c741-4682-9ca6-0ccc5e7e69fe", country: "BE", name: "لوكاس بيترز", focus: "EURUSD",
    bio: "متداول بلجيكي، يركّز على زوج اليورو مقابل الدولار ومتابعة قرارات البنك المركزي الأوروبي." },
  { id: "d2dde98a-38cb-4c5f-8c50-0af8dcfaae7b", country: "JP", name: "يوكي تاناكا", focus: "USDJPY",
    bio: "متداولة يابانية، متخصصة في زوج الدولار مقابل الين الياباني وتحليل أسواق آسيا." },
  { id: "4656a6d8-b486-4caa-83a5-fcdbe57f9a7d", country: "DE", name: "فيليكس فاجنر", focus: "EURUSD",
    bio: "متداول ألماني، يركّز على زوج اليورو مقابل الدولار ضمن أكبر اقتصاد في منطقة اليورو." },
  { id: "d52fd188-0145-4993-b189-98a7bc8202e7", country: "ZA", name: "سيفو نكوسي", focus: "XAUUSD",
    bio: "متداول من جنوب أفريقيا، متخصص في تداول الذهب انطلاقًا من خبرته في أحد أكبر أسواق إنتاجه عالميًا." },
  { id: "006cb6e5-4723-4b85-b128-c03187dbc8a1", country: "NG", name: "تشيوما أوكافور", focus: "BTCUSDT",
    bio: "متداولة نيجيرية، تركّز على العملات الرقمية في ظل الإقبال الكبير عليها في بلدها." },
  { id: "315b3fe8-4169-4c38-9297-fe3f8416694b", country: "FR", name: "كاميل لوران", focus: "EURUSD",
    bio: "متداولة فرنسية، تتابع زوج اليورو مقابل الدولار وتحركات الأسواق الأوروبية." },
  { id: "aa77a951-48d1-4333-bfbd-0f2bb981c4b0", country: "IN", name: "أنانيا شارما", focus: "ETHUSDT",
    bio: "متداولة هندية، متخصصة في العملات الرقمية ضمن واحد من أسرع أسواق التداول الرقمي نموًا." },
  { id: "1498ac2b-8805-410a-83b9-05cfb8bc0946", country: "KR", name: "جي وو كيم", focus: "SOLUSDT",
    bio: "متداولة كورية جنوبية، تركّز على العملات الرقمية في سوق معروف بنشاطه الكبير في هذا المجال." },
  { id: "aeda22ef-2562-4b02-a722-23a1ca8e1ef7", country: "CA", name: "إيميلي كارتر", focus: "US30",
    bio: "متداولة كندية، تتابع المؤشرات الأمريكية عن قرب نظرًا للتقارب الاقتصادي الكبير بين البلدين." },
  { id: "70699779-e1ff-4b82-ae51-1ad7132936f1", country: "TR", name: "إيليف يلماز", focus: "XAUUSD",
    bio: "متداولة تركية، متخصصة في تداول الذهب انطلاقًا من ثقافة الادخار به المنتشرة في بلدها." },
  { id: "1710f8c8-2ed5-4660-9ea7-ff6067575ac0", country: "BR", name: "بياتريز سوزا", focus: "BTCUSDT",
    bio: "متداولة برازيلية، تركّز على العملات الرقمية ضمن أحد أنشط أسواقها في أمريكا الجنوبية." },
  { id: "e9d1a7ab-86bc-43ee-95ab-bfea805f30e5", country: "NL", name: "سانه دي فريس", focus: "EURUSD",
    bio: "متداولة هولندية، تتابع زوج اليورو مقابل الدولار وأسواق أوروبا الغربية." },
  { id: "8ce7b41b-c8e0-45a9-8c70-dcc95a0b917b", country: "IT", name: "ماتيو رومانو", focus: "EURUSD",
    bio: "متداول إيطالي، يركّز على زوج اليورو مقابل الدولار وتحركات الاقتصاد الأوروبي." },
  { id: "a6201d3c-43a3-4ba8-89a7-fa0a59d277af", country: "AU", name: "كلوي أندرسون", focus: "XAUUSD",
    bio: "متداولة أسترالية، متخصصة في تداول الذهب انطلاقًا من مكانة بلدها كأحد أكبر منتجيه عالميًا." },
  { id: "d580d09c-666d-4e7d-a32a-ae475ebcca2c", country: "ES", name: "بابلو فرنانديز", focus: "EURUSD",
    bio: "متداول إسباني، يتابع زوج اليورو مقابل الدولار وأسواق جنوب أوروبا." },
  { id: "e9623130-3249-4903-93a9-9461b6d54929", country: "SE", name: "إريك ليندكفيست", focus: "EURUSD",
    bio: "متداول سويدي، يركّز على زوج اليورو مقابل الدولار ضمن أسواق شمال أوروبا." },
  { id: "fa01a15d-ef74-437f-882c-930bbb309cde", country: "MX", name: "دييغو هيرنانديز", focus: "US30",
    bio: "متداول مكسيكي، يتابع المؤشرات الأمريكية نظرًا للترابط الاقتصادي الكبير بين البلدين." },
  { id: "64b86189-401d-4f3e-9dc9-e64e1dd823de", country: "ID", name: "بايو براتاما", focus: "BNBUSDT",
