-- ============================================================
-- Copy Matrix — open positions were closing too quickly to feel
-- like a live, active market: scalpers held 3-20 minutes, high-risk
-- leaders held 1-3 days, and everyone else (moderate/session/
-- sporadic/flagship) held only 30-210 minutes before the engine
-- was eligible to close them. Stretched all three bands well out
-- (same closing mechanics, same skill/pnl math — just a longer
-- fuse before a signal becomes eligible for closing) so open
-- orders stay visible on trader profiles for much longer:
--   scalper:        3-20 min   -> 5-60 min
--   high_risk:      1-3 days   -> 2-7 days
--   everyone else:  30-210 min -> 4-48 hours
-- ============================================================
