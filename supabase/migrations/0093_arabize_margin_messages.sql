-- Fully Arabize the margin-related messages ("هامش" instead of the
-- English "Margin" term), phrased the way a global platform's Arabic
-- localization would read rather than a literal translation.
